...
let addTask = async () => {
    ...
    console.log(chalk.bgGreen(`${newTask.task} Task has been added successfully`));
};
...
let deleteTask = async () => {
    ...
    console.log(chalk.bgGreen(`${deleteTask} this task has been deleted successfully from your Todo-List Application.`));
};
...
let updateTask = async () => {
    ...
    console.log(chalk.bgGreen(`Task at index no. ${update_task_index.index - 1} updated successfully [for updated list check option: "View Todo-List"] `));
};
